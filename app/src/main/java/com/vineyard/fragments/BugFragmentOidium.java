...
public class BugFragmentOidium extends Fragment {
    ...
    private void displayMetaInfo(int position) {
        ...
        textDescription.setText(bugModelList.get(position).getBugDescription());
        textSings.setText(bugModelList.get(position).getBugSings());
        textPreparation.setText(bugModelList.get(position).getBugPreparation());
    ...
    private final ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                BugPagerAdapter bugPagerAdapter = new BugPagerAdapter(
                        getActivity(), bugModelList);
