...
public abstract  class PreparationAdapterFactory<
        TFIRSTHEADER, VFIRSTHEADER extends View & PreparationAdapterFactory.FirstHeaderBinder<TFIRSTHEADER>,
        THEADER, VHEADER extends View & PreparationAdapterFactory.HeaderBinder<THEADER>,
        TBODY,
        VFIRSTBODY extends View & PreparationAdapterFactory.FirstBodyBinder<TBODY>,
        VBODY extends View & PreparationAdapterFactory.BodyBinder<TBODY>,
        VSECTION extends View & PreparationAdapterFactory.SectionBinder<TBODY>
    ...
    public PreparationAdapterFactory(Context context) {
    }
